...
// Gap (Non-AI): No public portal (online permit tracking, doc submission)
// No public portal (online permit tracking, doc submission)
import React, { useState } from 'react';

export default function GapNoPublicPortalOnlinePermitTrackingDocSubmisPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-public-portal-online-permit-tracking-doc-submis/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No public portal (online permit tracking, doc submission)</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>No public portal (online permit tracking, doc submission)</p>
