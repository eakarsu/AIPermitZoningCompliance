...
// Gap (Non-AI): No webhooks for inspection scheduling triggers
// No webhooks for inspection scheduling triggers
import React, { useState } from 'react';

export default function GapNoWebhooksForInspectionSchedulingTriggersPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-webhooks-for-inspection-scheduling-triggers/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No webhooks for inspection scheduling triggers</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>No webhooks for inspection scheduling triggers</p>
