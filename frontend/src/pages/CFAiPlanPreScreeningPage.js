...
// Custom Feature: AI plan pre-screening
// AI plan pre-screening: Applicant uploads plans; AI auto-checks against common violations (setbacks, parking, frontage); highlights issues before submission; reduces review rework
import React, { useState } from 'react';

export default function CFAiPlanPreScreeningPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-ai-plan-pre-screening/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>AI plan pre-screening</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>AI plan pre-screening: Applicant uploads plans; AI auto-checks against common violations (setbacks, parking, frontage); highlights issues before submission; reduces review rework</p>
