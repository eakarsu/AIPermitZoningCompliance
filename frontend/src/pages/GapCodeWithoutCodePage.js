...
export default function GapCodeWithoutCodePage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-code-without-code/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Code without '/code</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Code without /code-interpretation-assistant (NLP clarification of ambiguous code sections)</p>
